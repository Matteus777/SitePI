...
<html>
    <head>
        <title>Fundo de Olho - Clinica Bom Olhar</title>
        <meta charset="UTF-8">        
    ...
    <body>
        ...
        <br>
        <br>
        <div align="center" class="textos"><h1>Exame de Fundo de Olho</h1></div>
        <div align="center"><img src="img/fundo.png"></div>
               <br>
        <br>
        <br>
        <br>
